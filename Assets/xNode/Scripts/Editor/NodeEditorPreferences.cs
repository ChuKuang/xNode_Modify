...
namespace XNodeEditor
{
    ...
    public static class NodeEditorPreferences
    {
        ...
        {
            [SerializeField] private Color32 _gridLineColor = new Color(0.23f, 0.23f, 0.23f);
            public Color32 gridLineColor { get { return _gridLineColor; } set { _gridLineColor = value; _gridTexture = null; _crossTexture = null; } }

            [SerializeField] private Color32 _gridBgColor = new Color(0.19f, 0.19f, 0.19f);
            ...
            public bool ShowConnectNode = false;
            [SerializeField] private Color32 _inPutNodeColor = new Color(0.49f, 0.29f, 0.05f);
            public Color32 InPutNodeColor { get { return _inPutNodeColor; } set { _inPutNodeColor = value; } }

            [SerializeField] private Color32 _outPutNodeColor = new Color(0.5f, 0.17f, 0.09f);
            public Color32 OutPutNodeColor { get { return _outPutNodeColor; } set { _outPutNodeColor = value; } }
        ...
        private static void SystemSettingsGUI(string key, Settings settings)
        {
            ...
            settings.ShowConnectNode = EditorGUILayout.Toggle(new GUIContent("ShowConnectNode", "Disable for Show ConnectNode"), settings.ShowConnectNode);

            if (settings.ShowConnectNode)
            {
                settings.InPutNodeColor = EditorGUILayout.ColorField(new GUIContent("InPutNodeColor"), settings.InPutNodeColor);
                settings.OutPutNodeColor = EditorGUILayout.ColorField(new GUIContent("OutPutNodeColor"), settings.OutPutNodeColor);
            }
